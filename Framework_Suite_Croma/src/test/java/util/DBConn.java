...
public class DBConn{
	...
	public static String server = "EndlessAisle_APITestDb";
	public static String connURL = "jdbc:postgresql://localhost:5432/"+server;
	...
	public static ArrayList<HashMap<String, String>> DBConn(String query) {
		...
		try {
			...
			System.out.println("Col count :" + numberOfColumns);
			...
			System.out.println("Size of arrayListOfHashMap:-"+arrayListOfHashMap.size());
